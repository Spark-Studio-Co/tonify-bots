    ...
    <>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-center text-base mt-2">
          Закрытые Telegram-каналы — это аудитория без лишнего шума и конкуренции. Мы подбираем топовые площадки.
        </p>
        <Pagination currentPage={1} totalPages={3} onPageChange={() => console.log("lol")} />
      </div>
      <Button text="Продолжить" onClick={() => setCurrentState(2)} className="mt-[111px]" />
