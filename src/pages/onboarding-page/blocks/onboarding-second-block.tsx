    ...
    <>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-center text-base mt-2">
          Закрытые каналы – это вовлеченная аудитория, минимальная конкуренция и высокая конверсия.
        </p>
        <Pagination currentPage={2} totalPages={3} onPageChange={() => console.log("lol")} />
      </div>
      <Button text="Продолжить" onClick={() => setCurrentState(3)} className="mt-[111px]" />
